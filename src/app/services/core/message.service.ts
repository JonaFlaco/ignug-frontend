...
export class MessageService {
  ...
  get createCupo() {
    return Swal.fire({
      title: 'Cupo Creado',
      html: 'Ahora puede descargar su solicitud de inscripción',
      icon: 'info'
    });
  }
  ...
  get errorsPdfFields() {
    return Swal.fire({
      title: 'Revise los campos',
      html: 'Revise que los campos estén llenos, si no no se generara el pdf',
      icon: 'error'
    });
  }
  ...
  get succesPdfFields() {
    return Swal.fire({
      ...
      html: 'El file.pdf debe estar en su carpeta de descargas',
      icon: 'success'
    });
  }

  questionApprove(title = '¿Está seguro de cambiar el estado?', text = 'No podrá cambiar esta información!') {
    return Swal.fire({
      title,
      text,
      icon: 'question',
      ...
      confirmButtonText: '<i class="pi pi-check"> Si, cambiame</i>'
    });
  }

  get succesInscription() {
    return Swal.fire({
      title: 'Inscripción Descargada',
      html: 'Su solicitud de Inscripción debe estar en su carpeta de descargas',
      icon: 'success'
    });
  }
  get succesMemoSignature() {
    return Swal.fire({
      title: 'Memorando Descargado',
      html: 'Revise su carpeta de descargas',
      icon: 'success'
    });
  }
  ...
  get succesFields() {
    return Swal.fire({
      title: 'Certificado de la Matricula generado correctamente',
      html: 'Su Cetificado debe estar en su carpeta de descargas',
      icon: 'success'
    });
  }
