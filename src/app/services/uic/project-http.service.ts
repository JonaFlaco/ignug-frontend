...
import { CreateProjectDto, ProjectModel, UpdateProjectDto } from '@models/uic';
...
export class ProjectsHttpService {
  ...
  catalogue(type: CatalogueTypeEnum): Observable<ProjectModel[]> {
  ...
  findAll(page: number = 0, search: string = ''): Observable<ProjectModel[]> {
    const url = this.API_URL;
