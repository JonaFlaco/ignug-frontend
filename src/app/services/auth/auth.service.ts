...
export class AuthService {
  ...
  get teacher(): TeacherModel | null {
    return JSON.parse(String(localStorage.getItem('teacher')));
  }

  set teacher(value: TeacherModel  | undefined | null) {
    localStorage.setItem('teacher', JSON.stringify(value));
  }

  get student(): StudentModel | null {
    return JSON.parse(String(localStorage.getItem('student')));
  }

  set student(value: StudentModel | undefined | null) {
