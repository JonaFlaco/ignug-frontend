...
import {FormatProyectPlanRoutingModule} from './format-proyect-plan-routing.module';
...
@NgModule({
  declarations: [
    FormatProyectPlanComponent,
    FormatProyectPlanFormComponent,
    //ProfileComponent,
  ],
  imports: [
    NgCommonModule,
    FormatProyectPlanRoutingModule,
    ReactiveFormsModule,
    SharedModule,
    //PrimeNg
    BadgeModule,
...
export class FormatProyectPlanModule {
}
