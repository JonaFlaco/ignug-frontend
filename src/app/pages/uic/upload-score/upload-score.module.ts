...
import {UploadScoreRoutingModule} from './upload-score-routing.module';
...
import { UploadScoreListComponent } from './upload-score-list/upload-score-list.component';
...
@NgModule({
  declarations: [
    ...
    UploadScoreFormComponent,
    UploadScoreListComponent,

  ],
  imports: [
    NgCommonModule,
    UploadScoreRoutingModule,
    ReactiveFormsModule,
    SharedModule,
    //PrimeNg
    BadgeModule,
