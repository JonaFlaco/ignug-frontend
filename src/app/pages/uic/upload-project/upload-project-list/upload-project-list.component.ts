...
@Component({
  selector: 'app-upload-project-list',
  templateUrl: './upload-project-list.component.html',
})
export class UploadProjectListComponent implements OnInit {
  columns: ColumnModel[];
