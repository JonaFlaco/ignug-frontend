...
@Component({
  selector: 'app-planification-student-list',
  templateUrl: './planification-student-list.component.html',
  styleUrls: ['./planification-student-list.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PlanificationStudentListComponent implements OnInit {
  columns: ColumnModel[];
