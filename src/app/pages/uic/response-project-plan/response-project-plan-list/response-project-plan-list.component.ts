...
@Component({
  selector: 'app-response-project-plan-list',
  templateUrl: './response-project-plan-list.component.html',
  styleUrls: ['./response-project-plan-list.component.scss']
})
export class ResponseProjectPlanListComponent implements OnInit {
  ...
  getColumns(): ColumnModel[] {
    return [
      ...
      {field: 'studentSelect', header: 'Estudiante'},
  ...
  redirectCreateForm() {
    this.router.navigate(['/uic/response-project-plans', 'new']);
  }

  redirectEditForm(id: string) {
    this.router.navigate(['/uic/response-project-plans', id]);
  }
